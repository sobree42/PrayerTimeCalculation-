...
<br>
<h2 class="w3-jumbo-50 f-white"> أختر مقاطعة الولاية الخاصة بك: </h2>
<br>
<center>
...
<div align="center" style="margin-top: 7px; flout:right;" class="TimeFormat01">
	تنسيق الوقت: <a id="time-format" href="javascript:switchFormat(1)" class="command"></a>
</div>
