...
//---------------------- Global Variables --------------------
	...
	this.calcMethod   = 6;		// Calculation method 
	this.asrJuristic  = 0;		// Juristic method for Asr
	this.dhuhrMinutes = 5;		// minutes after mid-day for Dhuhr
...
//------------------- Calc Method Parameters --------------------
	...
	*/
	...
	this.methodParams[this.Custom]	= new Array(17, 0, 1, 0, 17);		/* Islam in Thailand*/
...
PrayTime.prototype.computeTimes = function(times)
{
	...
	return new Array(Fajr, Sunrise, Dhuhr, Asr, Sunset, Maghrib, Isha ,ArabDay);
}
...
{
	var times = new Array(5, 6, 12, -10, 18, 18, 18); //default times
